...
it('it should transport GSRT-B01-11 successfully', function (done) {
  ...
  "destination_container_location": "DOCK-02"
        ...
        //shipment 16
        it('it should transport GSRT-B01-14 successfully', function (done) {
            request
            .post('/item/transport')
            .set('x-access-token', token)
            .send({
  "shipment_id": "SS-ZEU-180816-16",
  "grid_id": "GSRT-B01-14",
  "customer_secondary_id": "SCC-004109",
  "source_container": "GRC-018",
  ...
  "destination_container_location": "DOCK-02"
        ...
        it('it should transport GSRT-B01-12 successfully', function (done) {
            request
            .post('/item/transport')
            .set('x-access-token', token)
            .send({
  "shipment_id": "SS-ZEU-180816-18",
  "grid_id": "GSRT-B01-12",
  "customer_secondary_id": "SCC-003605",
